<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <a class="navbar-brand brand-logo-mini" href="index.html"><h3 class="mt-2" style="font-weight: 300">TS</h3>{{--<img src="{{asset('admin_assets/assets/images/logo-mini.svg')}}" alt="logo" />--}}</a>
    </div>
